    ...
    if query == "generate":
        ...
        try:
            if query == "pyrogram":
                ...
                await callback_query.answer("جلسـة سيـشن البـوت مـن التحديـث الجـديـد من بايࢪوجـرام", show_alert=True)
...
ERROR_MESSAGE = "** هنـاك مشكـلة يࢪجـى ابـلاغ المطـور @EEc5e **"
